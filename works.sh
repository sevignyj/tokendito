tag=$1
docker buildx build . --provenance=false --platform linux/arm64 --tag docker.io/jpsevigny/jptest:$tag-arm64 --push
docker buildx build . --provenance=false --platform linux/amd64 --tag docker.io/jpsevigny/jptest:$tag-amd64 --push
